"""
Sports Arena Reservation System - Django settings
This project demonstrates how to map the thesis database and access control design into Django.
"""
...
INSTALLED_APPS = [
    ...
    "management_portal.apps.ManagementPortalConfig",
]
...
ROOT_URLCONF = "sports_arena.urls"
...
WSGI_APPLICATION = 'sports_arena.wsgi.application'
